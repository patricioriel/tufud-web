            ...
            <div className="row d-flex justify-content-center my-5">
              ...
              <div className="card bg-transparent shadow rounded border-0 h-100">
                  <div className="card-body text-center p-5">
                    ...
                    <p className="text-start cuerpocard_testimonios">Ahorro de tiempo y recursos. Reducción de desperdicios. La plataforma es colaborativa y mejora la comunicación con el equipo de trabajo. Los pedidos se realizan de manera rápida y precisa.</p>
                    <p className="text-start titulos_cards_testimonios mb-0">Sebastián Estevanez</p>
