      ...
      <div className="container containernoticias my-5">
        <div className="row justify-content-center align-items-center">
          <div className="col-md-6 col-sm-12 card_testimonios">
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="54" fill="currentColor" className="icono_testimonio bi bi-quote d-flex" viewBox="0 0 16 16">
            ...
            <div className="d-flex align-items-center mt-4">
                <img className="me-3" width="100px" src={testimonios[noticiaActual].imagen} alt="" />
                <div ClassName="">
                    <p className="cuerpo text-start mb-0">{testimonios[noticiaActual].persona}</p>
                    <p className="cuerpo text-start">{testimonios[noticiaActual].puesto}</p>
                </div>         
            </div>    
          </div>
          <div className="col-md-6 ps-5">
            <h3 className="titulos_cards text-start text-uppercase">Testimonios</h3>
            <h4 className="titulo text-start quicksand">Podemos hablarte sobre nuestros beneficios</h4>
            <p className="text-start cuerpo">Pero no hay mejor testimonio que el de nuestra comunidad.</p>
        </div>
          ...
          <Link className="btn btnnoticia mt-5 pt-2 pb-2" to="/testimonios/all">Ver todas las Historias</Link>
        </div>
      </div>
    </div>
  );
