...
function Noticia1() {
    return (
        <div className='container-fluid'>
            ...
            <div className='w-50 text-start mt-5 detallenoticia'>
                ...
                <h3 className='titulocard fw-bold'>¿Cómo pueden los restaurantes utilizar la tecnología para mejorar su procesos?</h3>
