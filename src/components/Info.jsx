...
function Info() {
  ...
  <div className="col-md-5 order-md-2 colinicio1">
    <img src={img1home} alt="Descripción de la imagen" className='imginfo mt-3 img-fluid ps-5'/>
  </div>
  <div className="col-md-5 order-md-1 colinicio2">
    <div>
      <h1 className='fw-bold text-start quicksand titulo mb-4 tituloinicio'>Somos la plataforma de <span className='morado'>pedidos</span> que revoluciona la <span className='morado'>industria gastronómica</span></h1>
    ...
    <div className="row my-3 text-start cajabotones">
      ...
      <Link to={"/proveedor"} className="btn my-4 botones_info ms-5 btninfo1 btnprov">Soy Proveedor</Link>       
    </div>        
  </div>
</div>
